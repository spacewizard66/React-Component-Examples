...
function Weather() {
    ...
    // Function to Fetch API data when a search input in Entered
    const fetchAPI = async(event) => {
        // Checks if the Event was the Enter Key
        if (event.key === 'Enter') {
            try {
    ...
    // Initializes the Unit variable to be Fahrenheit temperature
    useEffect(() => {
        setUnit(true)
    }, []);
